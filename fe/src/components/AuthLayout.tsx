  ...
  return (
    <View className="flex-1 ">
      <View className="flex-1 bg-white">
        ...
        <View className="mx-auto px-5 mt-6 items-center">
          <Text className="text-black-700 font-sans-semibold tracking-[-0.32px] text-[32px] text-center">
            {title}
          </Text>
          <Text className="mt-1 mx-5 text-gray-700 text-base font-sans-regular text-center">
            {subtitle}
          </Text>
        </View>

        <View className="flex-1 mb-10 px-6" style={{ marginBottom: bottom }}>
          {children}
        </View>
      </View>
    </View>
